...
def main():
    parser = argparse.ArgumentParser(description='Evaluate trained NBA prediction models')
    parser.add_argument('--models', default='artifacts/models/', help='Directory containing trained models')
    parser.add_argument('--data', default='data/processed/features_enhanced_3seasons.parquet',
                       help='Processed features file')
    parser.add_argument('--output', default='reports/evaluation_report.md',
                       help='Output path for evaluation report')
    parser.add_argument('--verbose', action='store_true', help='Print detailed results for each target')
